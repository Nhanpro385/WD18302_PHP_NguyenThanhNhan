...
<div class="login-box">
    ...
    <div class="card">
        <div class="card-body login-card-body">
            <p class="login-box-msg">Vui lòng nhập địa chỉ otp của bạn để khôi phục mật khẩu.</p>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#forgotPasswordForm').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '?url=AjaxController/hanldeOTP',
                data: formData,
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        Swal.fire({
                            ...
                            didClose: () => {
                                window.location.href = '?url=UpdatePasswordController/updatePass';
                            }
                        });
                    }
                },
